...
public class BinaryTreeByLinkedList {
	...
	public void search(int value) {
		...
		while (!queue.isEmpty()) {
			...
			BinaryNode prasentNode = queue.remove();
			if (value == prasentNode.getValue()) {
				System.out.println("Value-" + value + " is found in Tree !");
				return;
			} else {
				if (prasentNode.getLeft() != null) {
					queue.add(prasentNode.getLeft());
				}
				if (prasentNode.getRight() != null) {
					queue.add(prasentNode.getRight());
				}
			}
	...
	public void deleteNodeOfBinaryTree(int value) {
		...
		while (!queue.isEmpty()) {
			BinaryNode prasentNode = queue.remove();
			if (prasentNode.getValue() == value) {
				prasentNode.setValue(getDeepestNode().getValue());
				DeleteDeepestNode();
